...
<body>
	<center>
		<form action="examenf.php" method="post">
		...
		<input type="checkbox" name="b" value="bi">Tarjeta Bi<br>
...
$sql="insert into tomaa values('$nombre','$nit','$parcial','$d0','$d1','$d2','$d3','$d4','$recargo','$total')";
$cn=mysqli_connect("localhost","root","","Ella");
mysqli_query($cn,$sql);
echo"Datos Insertados Correctamente";
$sxl="select Nombre,Nit,Parcial,D0,D1,D2,D3,D4,recargo,Total from tomaa";
